...
public class DinggaoAdapter extends RecyclerView.Adapter<DinggaoAdapter.ViewHolder> implements View.OnClickListener {

    private Context mContext;
    private List<DinggaoData> mDatas;
    ...
    public DinggaoAdapter(Context context, List<DinggaoData> datas) {
        mContext = context;
        mDatas = datas;
    }
    ...
    @NonNull
    @Override
    public DinggaoAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.recycler_view_te_shenbao, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DinggaoAdapter.ViewHolder holder, int position) {
