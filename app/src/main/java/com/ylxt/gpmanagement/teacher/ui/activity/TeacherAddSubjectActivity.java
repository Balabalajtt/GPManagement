...
import com.ylxt.gpmanagement.teacher.presenter.AddSubjectPresenter;
import com.ylxt.gpmanagement.teacher.presenter.view.AddSubjectView;
import com.ylxt.gpmanagement.work.ui.activity.MainActivity;
...
public class TeacherAddSubjectActivity extends BaseMvpActivity<AddSubjectPresenter> implements AddSubjectView, View.OnClickListener{
...
//    private File mFile = null;
    private static final String TAG = "TeacherAddSubject";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPresenter = new AddSubjectPresenter();
...
//
//        }
//        Toast.makeText(TeacherAddSubjectActivity.this, msg, Toast.LENGTH_SHORT).show();
//    }
//
//    @Override
...
//
//        if (status == 1) {
//            startActivity(new Intent(TeacherAddSubjectActivity.this, MainActivity.class));
//            finish();
//        }
//        Toast.makeText(TeacherAddSubjectActivity.this, msg, Toast.LENGTH_SHORT).show();
//    }
    ...
    @Override
    public void onPublish(int status, String msg) {
