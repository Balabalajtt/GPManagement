...
public class ShengbaoServceImpl implements ShengbaoService {
    ...
    @Override
    public Observable<ResponseBody> postFujian(int type, MultipartBody.Part body) {
        return RetrofitFactory.INSTANCE.create(SubjectApi.class).postFujian(type, body);
    }
}
